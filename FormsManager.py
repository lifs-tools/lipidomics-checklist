try:
    ...
    def dbconnect():
        try:
            ...
            print_error(str(ErrorCodes.NO_DATABASE_CONNECTION) + " in dbconnect", e)
            exit()
    ...
    def get_encrypted_entry(entry_id):
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_GETTING_MAIN_FORMS) + " in get_encrypted_entry", e)
    ...
    def get_decrypted_entry(entry_id):
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_GETTING_MAIN_FORMS) + " in get_decrypted_entry", e)
    ...
    if content["command"] == "get_lang_dict":
        ...
        try:
            ...
            print_error(str(ErrorCodes.INVALID_COMMAND_ARGUMENT) + " in %s" % content["command"], e)
    ...
    if content["command"] == "get_published_forms":
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_GETTING_CLASS_FORMS) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_GETTING_SAMPLE_FORMS) + " in %s" % content["command"], e)
    ...
    ################################################################################
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_ADDING_MAIN_FORMS) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_ADDING_CLASS_FORMS) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_ADDING_SAMPLE_FORMS) + " in %s" % content["command"], e)
    ...
    ################################################################################
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_DELETING_MAIN_FORM) + " in %s" % content["command"], e)
    ...
    ################################################################################
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_EXECUTING_FUNCTION) + " in %s" % content["command"], e)
    ...
    ################################################################################
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_DELETING_CLASS_FORM) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_DELETING_SAMPLE_FORM) + " in %s" % content["command"], e)
    ...
    ################################################################################
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_CREATING_PDF) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.PUBLISHING_FAILED) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.INVALID_MAIN_ENTRY_ID) + " in %s" % content["command"], e)
            exit()
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_DECODING_FORM) + " in %s" % content["command"], e)
            exit()
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_GETTING_REPORT_LINK) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_EXPORTING_FORMS) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_IMPORTING_FORMS) + " in %s" % content["command"], e)
        ...
        try:
            ...
            print_error(str(ErrorCodes.ERROR_ON_EXPORTING_REPORT) + " in %s" % content["command"], e)
    ...
    print_error("ErrorCodes.GENERIC", e)
